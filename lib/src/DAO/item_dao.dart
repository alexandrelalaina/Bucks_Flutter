...
class ItemDAO extends BaseDAO<Item> {
  ...
  String get sqlComJoin =>
      'select it.id, it.descr, it.cd, it.cdControlaEstoque ' +
      ' , it.fkItemTipoId  as fk_item_tipo_id' +
      ' , it.fkItemGrupoId as fk_item_grupo_id' +
      ' , it.fkItemUnmedId as fk_item_unmed_id ' +
